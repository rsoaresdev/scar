...
export function HomepageLevelUp({ logo }) {
 ...
 const setIt = () => {
  ...
  setLevel(rangeRandomizer(1, 10));
  setXp(rangeRandomizer(5, 79));
 };
 ...
 return (
  <div className="mt-6 flex flex-row items-center gap-1">
   ...
   <span className="ml-2">
    <span className="font-bold">Scar</span> leveled up to <span className="text-accent-primary font-bold [font-feature-settings:'tnum']">level {level}</span>{" "}
