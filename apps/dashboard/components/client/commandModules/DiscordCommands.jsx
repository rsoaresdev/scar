  ...
  return (
   <>
    ...
    <div className="mt-8 flex flex-wrap gap-2">
     {Array.from({ length: 8 }).map((_, i) => (
      <TextSkeleton
       ...
       className="!h-[42px]"
       style={{
        width: `${rangeRandomizer(64, 150)}px !important`,
       }}
      />
     ))}
    </div>
    ...
    <div className="mt-8 flex flex-col items-center justify-center gap-2">
     <Header3 className="flex items-center text-center text-xl font-bold">
     ...
     {filteredCategories
      ...
      .map((category) => (
       <div key={category.name} className="mt-8">
        <Header3 className="text-left text-xl font-bold">
