  ...
  <>
   ...
   <aside
    className={clsx(
     ...
     "bg-background-navbar fixed z-[9998] mt-8 flex h-screen w-64 flex-none flex-col flex-nowrap overflow-y-auto overflow-x-hidden border-r border-r-neutral-800 py-8 pb-32 shadow-lg duration-100 md:pointer-events-auto md:top-0 md:mt-16 md:flex md:opacity-100"
    )}
   >
    <div className="px-4">
