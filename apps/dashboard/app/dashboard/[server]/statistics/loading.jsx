   ...
   <div className="flex flex-col gap-6">
    <Block>
     <div className="mb-4 flex flex-col items-center justify-normal gap-2 whitespace-nowrap lg:flex-row">
      <Header2 className="w-full flex-col items-center gap-1 lg:items-start">
       <span>
        New Members <Icons.refresh className={iconVariants({ variant: "large", className: "text-accent-primary animate-spin!stroke-2 ml-2 inline-block align-middle" })} />
       </span>
    ...
    <Block>
     <div className="mb-4 flex flex-col items-center justify-normal gap-2 whitespace-nowrap lg:flex-row">
      <Header2 className="w-full flex-col items-center gap-1 lg:items-start">
       <span>
        Members left <Icons.refresh className={iconVariants({ variant: "large", className: "text-accent-primary animate-spin!stroke-2 ml-2 inline-block align-middle" })} />
       </span>
       <span className="text-left text-sm font-normal opacity-40">Loading...</span>
      </Header2>
      <div className="relative mx-auto flex flex-row items-center justify-center gap-3 lg:ml-auto lg:mr-0">
    ...
    <Block>
     <div className="mb-4 flex flex-col items-center justify-normal gap-2 whitespace-nowrap lg:flex-row">
      <Header2 className="w-full flex-col items-center gap-1 lg:items-start">
       <span>
        Messages Sent <Icons.refresh className={iconVariants({ variant: "large", className: "text-accent-primary animate-spin!stroke-2 ml-2 inline-block align-middle" })} />
       </span>
       <span className="text-left text-sm font-normal opacity-40">Loading...</span>
      </Header2>
      <div className="relative mx-auto flex flex-row items-center justify-center gap-3 lg:ml-auto lg:mr-0">
