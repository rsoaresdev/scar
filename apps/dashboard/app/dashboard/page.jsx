import { getServers, isBotInServer } from "@scar/util/functions/guild";
    ...
    <div className="flex flex-row flex-wrap justify-center gap-4 sm:flex-col">
     {servers && servers.length > 0 ? (
      servers.map((server) => (
       <div key={server.id}>
        <div className="hidden flex-row items-center justify-start gap-4 sm:flex">
         ...
         <Header3 className="text-center text-xl font-bold">{server.name}</Header3>
         <>
          {server.bot ? (
      ...
      <div className="flex flex-col items-center justify-center gap-4">
       <Header3 className="text-center text-xl font-bold">You don't have any servers!</Header3>
