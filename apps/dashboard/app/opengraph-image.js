...
export const alt = "Scar. A groundbreaking Discord Bot!";
   ...
   >
    <img
     ...
     style={{
      ...
      marginBottom: "20px",
      borderRadius: "50%",
      boxShadow: "0px 0px 277px 3px #101110",
     }}
    />
    <div
     style={{
    ...
    >
     Scar will not only keep your server entertained but also assist you with moderation and many other things!
    </div>
   </div>
  ),
  {
