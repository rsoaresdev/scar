 ...
 if (createdRule) {
   ...
   actions: [
    {
     ...
     metadata: {
      ...
      customMessage: "Message blocked due to containing an invite link. Rule added by Scar",
     },
    },
   ],
  ...
  if (logChannel) {
   ...
   ruleToCreate.actions.push({
    ...
    metadata: {
     channel: logChannel,
     message: "Message blocked due to containing an invite link. Rule added by Scar",
    },
   });
  }
