...
import { timeoutMember } from "../../util/moderation/timeout.js";
...
export default {
 ...
 options: [
  ...
  },
  {
   ...
   options: [
    {
     name: "user",
     description: "The user who should be timeout",
     required: true,
     type: ApplicationCommandOptionType.User,
    },
    {
 ...
 run: async (client, interaction, guildSettings) => {
  ...
  if (subcommand === "ban") {
   ...
   await timeoutMember(client, interaction, guildSettings?.embedColor || client.config.defaultColor);
